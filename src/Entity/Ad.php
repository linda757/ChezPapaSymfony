 ...
 * @UniqueEntity(
 *     fields={"title"},
 *     message="Une annonce a déjà ce titre, merci de mettre un autre titre"
 * )
 */
class Ad
{
     ...
     * @Assert\Length(min=10,max=255,minMessage="Le titre doit faire plus de 10 caractères",maxMessage="Votre titre est trop long, pas plus de 255 caractères")
     */
    private $title;
    ...
    // Permet de trouver les jours non disponibles
        public function getNotAvailableDays(){
        $notAvailableDays = [];
        foreach($this->bookings as $booking){
            // $resultat = range(10,20,2); =>[10,12,14,16,18,20] compte de de 2 en 2
            // $resultat = range(03-20-2019,03-25-2019); => [] Calcul difficile
