...
class Booking
{
     ...
     * @ORM\Column(type="datetime")
     * @Assert\Date(message="le format doit être une date")
     * @Assert\GreaterThan(propertyPath="startDate",message="La date de départ doit être différente de la date d'arrivée.")
     */
    private $endDate;
    ...
    public function prePersist(){
        ...
        if(empty($this->amount)){
            // prix de l'annonce x nbre de jour
            $this->amount = $this->ad->getPrice() * $this->getDuration();
        }
    }

    //Permet de savoir si les dates sont déjà prises ou pas
        ...
        // Comparer
            $notAvailableDays = array_map(function($days){
    ...
    /**
     * Calcul le nbre de jour pour le séjour
     */
